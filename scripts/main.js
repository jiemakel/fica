...
(function (app) {
    ...
    var Snippet = (function () {
        function Snippet(before, beforeS, match, after, afterS, fulltext, id) {
            this.before = before;
        ...
        CeecConcordComponentController.prototype.setSortBy = function (index) {
            ...
            if (this.sortBy === 0)
                this.concordances.sort(function (a, b) {
                    return a.beforeS < b.beforeS ? (_this.sortDesc ? 1 : -1) : (a.beforeS > b.beforeS ? (_this.sortDesc ? -1 : 1) : 0);
                });
            else if (this.sortBy === 1)
                this.concordances.sort(function (a, b) { return a.match < b.match ? (_this.sortDesc ? 1 : -1) : (a.match > b.match ? (_this.sortDesc ? -1 : 1) : 0); });
            else
                this.concordances.sort(function (a, b) { return a.afterS < b.afterS ? (_this.sortDesc ? 1 : -1) : (a.afterS > b.afterS ? (_this.sortDesc ? -1 : 1) : 0); });
        };
            ...
            this.sparqlService.query('http://ldf.fi/ceec/sparql', CeecConcordComponentController.query.replace(/<REGEXP>/g, this.sparqlService.stringToSPARQLString(regexS)).replace(/<QUERY>/g, this.sparqlService.stringToSPARQLString(this.word)) + (limit ? 'LIMIT 31' : '')).then(function (response) {
                ...
                response.data.results.bindings.forEach(function (r) {
                    ...
                    for (var i = 2; i < parts.length; i += 2) {
                        ...
                        _this.concordances.push(new Snippet(_this.$sce.trustAsHtml(before), beforeS[beforeS.length - 1].toLowerCase(), parts[i - 1], _this.$sce.trustAsHtml(after), after.toLowerCase(), _this.$sce.trustAsHtml(ft), r['id'].value.replace('http://ldf.fi/ceec/letter_', '')));
                    }
                });
...
//# sourceMappingURL=data:application/json;charset=utf8;base64,
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/ceec-concord.html',
    ...
    '  </tr>\n' +
    '  <tr ng-repeat="row in $ctrl.concordances track by $index" ng-click="$ctrl.open(row.id)">\n' +
    '    <td class="text-right" popover-append-to-body="true" ng-bind-html="row.before" uib-popover-template="\'popover.html\'" popover-trigger="mouseenter" popover-placement="bottom"></td>\n' +
